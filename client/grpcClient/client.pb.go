...
type RequestId struct {
	...
	Anio     string `protobuf:"bytes,6,opt,name=anio,proto3" json:"anio,omitempty"`
}
...
func (x *RequestId) GetAnio() string {
	if x != nil {
		return x.Anio
	}
	return ""
...
var file_client_proto_rawDesc = []byte{
	...
	0x04, 0x61, 0x6e, 0x69, 0x6f, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x61, 0x6e, 0x69,
	0x6f, 0x22, 0x1f, 0x0a, 0x09, 0x72, 0x65, 0x70, 0x6c, 0x79, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12,
